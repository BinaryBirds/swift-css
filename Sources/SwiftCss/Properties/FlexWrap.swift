...
public enum FlexWrapValue: String {
    /// Default value. Specifies that the flexible items will not wrap    Play it »
    case nowrap
    /// Specifies that the flexible items will wrap if necessary    Play it »
    case wrap
    /// Specifies that the flexible items will wrap, if necessary, in reverse order    Play it »
